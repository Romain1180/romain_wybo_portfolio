...
const baseColorMap1 = loader.load('./assets/porcelain/textures/Porcelain_Map1_BaseColor.png');
const metallicMap1 = loader.load('./assets/porcelain/textures/Porcelain_Map1_Metallic.png');
const normalMap1 = loader.load('./assets/porcelain/textures/Porcelain_Map1_Normal.png');
const roughnessMap1 = loader.load('./assets/porcelain/textures/Porcelain_Map1_Roughness.png');
const aoMap1 = loader.load('./assets/porcelain/textures/Porcelain_Map1_ao.png');
...
const baseColorMap2 = loader.load('./assets/porcelain/textures/Porcelain_Map2_BaseColor.png');
const metallicMap2 = loader.load('./assets/porcelain/textures/Porcelain_Map2_Metallic.png');
const normalMap2 = loader.load('./assets/porcelain/textures/Porcelain_Map2_Normal.png');
const roughnessMap2 = loader.load('./assets/porcelain/textures/Porcelain_Map2_Roughness.png');
const aoMap2 = loader.load('./assets/porcelain/textures/Porcelain_Map2_ao.png');
